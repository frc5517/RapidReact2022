...
public class Outdex extends CommandBase {
  ...
  /** Creates a new Outdex. */
  public Outdex(Indexer indexer, DoubleSupplier power) {
  ...
  @Override
  public void execute() {
    // Use the outdex method from the Indexer subsystem
    m_indexer.outdex(m_power.getAsDouble());
  }
